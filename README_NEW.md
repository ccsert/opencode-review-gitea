...
| Package | Description |
|---------|-------------|
| `@opencode-review/core` | Provider abstraction, events, templates |
| `@opencode-review/server` | Hono API server |
...
- [x] Gitea Actions integration
- [x] Docker support
- [x] Platform mode architecture
- [x] Multi-provider support (Gitea, GitHub, GitLab)
